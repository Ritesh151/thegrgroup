...
import '../components/CSS/Products.css'; // or
...
const CategoryPage = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      const products = [ 
        // (Copy the same static product list as in Products.jsx)
         // Scaffolding Accessories
        {
          ...
          image: "https://5.imimg.com/data5/SELLER/Default/2021/12/CS/EG/RT/2938942/ms-scaffolding-universal-jack-500x500.jpg",
          price: 1200,
          specifications: {
            material: "Mild Steel",
            maxHeight: "500 mm",
        ...
        },
        {
          ...
          image: "https://5.imimg.com/data5/SELLER/Default/2021/12/CS/EG/RT/2938942/expandable-joint-pins-500x500.jpg",
          price: 850,
          specifications: {
        ...
        },
        {
          ...
          image: "https://5.imimg.com/data5/SELLER/Default/2021/12/CS/EG/RT/2938942/top-cup-scaffolding-500x500.jpg",
          price: 950,
          specifications: {
            material: "Mild Steel",
            diameter: "48 mm",
    ...
    <>
      {categoryProducts.length === 0 ? (
        <div className="text-center py-5">
          <h3>No products found for {decodeURIComponent(name)}</h3>
        </div>
      ) : (
        <div className="row">
    ...
    <>
      ...
      <div className="product-section container">
        <div className="text-center mb-4">
          <h2 className="display-6">{decodeURIComponent(name)}</h2>
          <p style={{ color: "gold" }}>Products in category: {decodeURIComponent(name)}</p>
          <hr />
        </div>
